                          ...
                          <div className="space-y-2.5">
                             <div className="flex items-center gap-2 text-slate-500">
                               ...
                               <input 
                                  ...
                                  className="bg-transparent border-none text-[10px] font-bold focus:ring-0 p-0 w-full"
                                />
                             </div>
                             <div className="flex items-center gap-2 text-slate-500">
                               ...
                               <select 
                                 ...
                                 className="bg-transparent border-none text-[10px] font-bold focus:ring-0 p-0 w-full cursor-pointer"
                               >
                             ...
                             <div>
                               ...
                               <div className="space-y-2">
                                 {interview.postTodos.map(todo => (
                                   <div key={todo.id} onClick={() => toggleTodo(interview.id, todo.id, 'post')} className="flex items-start gap-2 cursor-pointer group/todo">
                                     {todo.completed ? <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0 mt-0.5" /> : <Circle className="w-3.5 h-3.5 text-slate-300 shrink-0 mt-0.5 group-hover/todo:text-indigo-400 transition-colors" />}
